...
export const setCurrentSong = (song) => ({type: SET_CURRENT_SONG, currentSong: song})
export const setList = (currentSongList) => ({type: SET_LIST, currentSongList: currentSongList})
